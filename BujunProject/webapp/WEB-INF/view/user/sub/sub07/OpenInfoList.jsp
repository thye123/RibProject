...
<div class="con_mob_pad">
		...
		<table class="tb_board">
			...
			<tbody>
				<tr>
					...
					<td>연 1회</td>
					<td>매년 2월</td>
					<td><a href="./7406.php?pagetype=&pageno=1&bbsid=7406&qstr=&m1=11&m2=03&category=%C1%D6%BF%E4%BE%F7%B9%AB%B0%E8%C8%B9">인터넷정보공개방</a></td>
					<td class="bnon">&nbsp;</td>
				</tr>
			</tbody>
		</table>
	...
	<h3 class="tbul1">평생교육프로그램 관련 안내</h3>
	<div class="scroll_info">
		<span class="arr_l"></span>
		<span class="scroll_icon"></span>
		<p class="pinfo">좌우로 스크롤 하시면 전체 내용을 확인하실 수 있습니다.</p>
		...
		<table class="tb_board">
			...
			<tbody>
				<tr>
					...
					<td>수시</td>
					<td>시행당시</td>
					<td><a href="./7406.php?pagetype=&pageno=1&bbsid=7406&m1=11&m2=03&category=%BF%B9%BB%EA%BF%A1+%B0%FC%C7%D1+%C1%A4%BA%B8">인터넷정보공개방</a></td>
					<td class="bnon">&nbsp;</td>
				</tr>
				<tr>
					<td>각종계약 사항</td>
