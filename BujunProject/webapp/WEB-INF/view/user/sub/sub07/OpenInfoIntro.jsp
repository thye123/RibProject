...
<div class="con_mob_pad">
	...
	<h2 class="tbul1 mg_b40">가. 공개 제도의 목적</h2>
	<ul class="con1">
		<li><span>1</span>국민의 알권리
			<ul>
				<li>공공기관의 정보공개 의무보다 국민의 알권리(정보공개청구권)우선</li>
			</ul></li>
		<li><span>2</span>국정에 대한 국민 참여 확대
			<ul>
				<li>국민의 국정참여를 실질화하여 정보에 대한 접근권 보장</li>
			</ul></li>
		<li><span>3</span>행정의 투명성과 신뢰성
			<ul>
				<li>공공기관이 중요정보를 적극적으로 사전에 공개하여 국민의 신뢰 확보</li>
			</ul></li>
		<li><span>4</span>국민의 권익보호
			<ul>
				<li>각종 사회문제(환경·교통·소비자·안전 등)에 대처하여 국민의 권익 보호를 위한 관련정보 접근권 보장</li>
			</ul></li>
	</ul>
	
	<h3 class="tbul1 mg_b40">나. 근거법령</h3>

	<ul class="charter_list1">
		<li><span class="num">1</span>공공기관의정보공개에관한법률(2013. 3. 23 개정)</li>
		<li><span class="num">2</span>공공기관의정보공개에관한법률시행령(2013. 3. 23 개정)</li>
		<li><span class="num">3</span>공공기관의정보공개에관한시행규칙(2011.11. 1 개정)</li>
		<li><span class="num">4</span>부산광역시교육청행정정보공개운영에관한규칙(2010. 8.26
			개정)]</li>
	</ul>


	<h3 class="tbul1 mg_b40">다. 정보공개 청구권자</h3>

	<ul class="charter_list1">
		<li><span class="num">1</span>대한민국 모든 국민(법인, 단체 포함)</li>
		<li><span class="num">2</span>외국인(청구권이 인정되는 외국인의 범위)
			<ul>
	...
	<h3 class="tbul1 mg_b40">라. 행정정보 공표기준</h3>
	...
	<h3 class="tbul1 mg_b40">마. 비공개 대상정보</h3>
	<div class="mg_b5">
		「공공기관의 정보공개에 관한 법률」제9조 제1항
		<ul>
			<li class="sbul">1호. 다른 법률 또는 법률이 위임한
				명령(국회규칙·대법원규칙·헌법재판소규칙·중앙선거관리위원회규칙·대통령령 및 조례에 한한다)에 의하여 비밀 또는 비공개사항으로
				규정된 정보</li>
			<li class="sbul">2호. 국가안전보장·국방·통일·외교관계 등에 관한 사항으로서 공개될 경우 국가의
				중대한 이익을 현저히 해할 우려가 있다고 인정되는 정보</li>
			<li class="sbul">3호. 공개될 경우 국민의 생명·신체 및 재산의 보호에 현저한 지장을 초래할 우려가
				있다고 인정되는 정보</li>
			<li class="sbul">4호. 진행 중인 재판에 관련된 정보와 범죄의 예방, 수사, 공소의 제기 및 유지,
				형의 집행, 교정, 보안처분에 관한 사항으로 공개될 경우 그 직무 수행을 현저히 곤란하게 하거나 형사피고인의 공정한 재판을
				받을 권리를 침해한다고 인정할 만한 상당한 이유가 있는 정보</li>
			<li class="sbul">5호. 감사·감독·검사·시험·규제·입찰계약·기술개발·인사관리·의사결정과정 또는
				내부검토과정에 있는 사항 등으로 공개될 경우 업무의 공정한 수행이나 연구·개발에 현저한 지장을 초래한다고 인정할 만한
				상당한 이유가 있는 정보</li>
			<li class="sbul">6호. 당해 정보에 포함되어 있는 이름·주민등록번호 등 개인에 관한 사항으로서 공개될
				경우 개인 사생활의 비밀 또는 자유를 침해할 우려가 있다고 인정되는 정보</li>
			<li class="sbul">7호. 법인, 단체 또는 개인(이하 "법인 등"이라 한다)의 경영·영업상 비밀에 관한
				사항으로서 공개될 경우 법인 등의 정당한 이익을 현저히 해할 우려가 있다고 인정되는 정보</li>
			<li class="sbul">8호. 공개될 경우 부동산 투기·매점매석 등으로 특정인에게 이익 또는 불이익을 줄
				우려가 있다고 인정되는 정보</li>
			</span>
	</div>

	<h3 class="tbul1 mg_b40">정보공개제도 공개기관</h3>
	<div class="mb_scroll">
		<table class="tbl_basic">
			...
			<tbody>
				<tr>
					<td>부산광역시립부전도서관</td>
					<td>우 614-845</td>
					<td>주소 : 부산시 부산진구 동천로 79<br /> (부전2동 168-269번지)
					</td>
					<td>T.<a href="tel : 051-802-5901">802-5901</a></td>
					<td>총무과</td>
				</tr>
			</tbody>
		</table>
	...
	<div class="mb_scroll">
		<table class="tbl_basic">
			...
			<thead>
				...
				<tr>
					<th scope="col">원본의 열람신청</th>
					<th scope="col">원본의 사본(출력물)<br /> 복제물&middot;인화물
					</th>
					<th scope="col">전산자료의<br /> 열람&middot;시청
					</th>
					<th scope="col">전산자료의<br /> 사본(출력물)&middot;복제물
					</th>
				</tr>
			</thead>
			<tbody>
