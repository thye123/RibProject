...
<script>
	window.onload=function(){
		...
		farea.addEventListener("click", function(){
			...
			if(conf==true) {
				location.href="/finref07/delFile?m1=02&m2=02&m3=05&ad_idx=${ad_idx}&ad_code=${ad_code}";
			}
		});
	}
</script>
	...
	<!-- table -->
		<form action="/finref07/Update" method="POST" enctype="multipart/form-data">
			...
			<div class="tb_boardss">
				...
				<button>수정</button>
				<a href="/finref07/view?m1=02&m2=02&m3=05&ad_idx=${board.ad_idx}&ad_code=${ad_code}" class="btn_01">취소</a>
			</div>
		</form>	
	<!-- //table -->
