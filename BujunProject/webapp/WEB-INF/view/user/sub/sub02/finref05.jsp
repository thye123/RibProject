					...
					<c:otherwise>
						<c:forEach var="bankboard" items="${bankBoardList}">
							<tr>
								...
								<td class="l"><a href="/finref05/view?m1=02&m2=02&m3=05&ad_idx=${bankboard.ad_idx}&ad_code=${ad_code}">${bankboard.ad_title}</a></td>
		...
		<div>
			...
			<c:choose>
				<c:when test="${sessionScope.mem_id == 'ADMIN' }">
						<div class="insertbtn">	
							<div class="btn_1"><a href="/finref05/WriteForm?m1=02&m2=02&m3=05">글쓰기</a></div>
						</div>
				</c:when>
				<c:otherwise>
