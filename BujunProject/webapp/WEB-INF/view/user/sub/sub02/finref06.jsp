...
<div class="con_mob_pad">
	...
	<div id="tab_depth01" class="w25">
		<ul>
			...
			<li class="active"><a href="/finref06?m1=02&m2=02&m3=05&nowpage=1&pagecount=10&grpnum=1">신문기사색인</a></li>
	...
	<div class="auto_box mg_b40">			
					...
					<c:otherwise>
						<c:forEach var="bankboard" items="${bankBoardList}">
							<tr>
								...
								<td><a href="/finref06/view?ad_idx=${bankboard.ad_idx}&ad_code=${ad_code}">${bankboard.ad_title}</a></td>
		...
		<div>
			<div class=paging>
				<%@include file="/WEB-INF/view/user/include/bankpaging3.jspf" %>
			</div>
			<div class="insertbtn">	
				<button class="btn_1"><a href="/finref06/WriteForm?m1=02&m2=02&m3=05">글쓰기</a></button>
			</div>
		</div>
	</div>
