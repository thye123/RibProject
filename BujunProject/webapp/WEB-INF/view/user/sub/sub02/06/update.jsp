...
<script>
	window.onload=function(){
		...
		farea.addEventListener("click", function(){
			...
			if(conf==true) {
				location.href="/finref06/delFile?m1=02&m2=02&m3=05&ad_idx=${ad_idx}&ad_code=${ad_code}";
			}
		});
	}
</script>
...
<div class="con_mob_pad">
	...
	<div class="auto_box mg_b40">		
		<form action="/finref06/Update" method="POST" enctype="multipart/form-data">
			<input type="hidden" value="CAT0013" name="ad_code">	
			...
			<div class="tb_boardss">
				...
				<button>수정</button>
				<a href="/finref06/view?m1=02&m2=02&m3=05&ad_idx=${board.ad_idx}&ad_code=${ad_code}" class="btn_01">취소</a>
			</div>
		</form>	
	</div>
	<!-- //table -->
