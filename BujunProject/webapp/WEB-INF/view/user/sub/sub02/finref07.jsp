...
<div class="con_mob_pad">
	...
	<div class="auto_box mg_b40">			
					...
					<c:otherwise>
						<c:forEach var="bankboard" items="${bankBoardList}">
							<tr>
								...
								<td><a href="/finref07/view?m1=02&m2=02&m3=05&ad_idx=${bankboard.ad_idx}&ad_code=${ad_code}">${bankboard.ad_title}</a></td>
		...
		<div>
			...
			<div class="insertbtn">	
				<button class="btn_1"><a href="/finref07/WriteForm?m1=02&m2=02&m3=05">글쓰기</a></button>
			</div>
		</div>
	</div>
