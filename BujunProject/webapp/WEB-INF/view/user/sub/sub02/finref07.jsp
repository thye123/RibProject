...
<div class="con_mob_pad">
	...
	<div id="tab_depth01" class="w25">
		<ul>
			...
			<li class="active"><a href="/finref07?m1=02&m2=02&m3=05&nowpage=1&pagecount=10&grpnum=1">알짜·경제금융상식</a></li>
		</ul>
	</div>
	
	<div class="tab_depth01" >
		<form action="/finref07" method="GET">
	...
	<!-- table -->
					...
					<c:otherwise>
						<c:forEach var="bankboard" items="${bankBoardList}">
							<tr>
								...
								<td class="l"><a href="/finref07/view?m1=02&m2=02&m3=05&ad_idx=${bankboard.ad_idx}&ad_code=${ad_code}">${bankboard.ad_title}</a></td>
		...
		<div>
			<div class=paging>
				<%@include file="/WEB-INF/view/user/include/bankpaging4.jspf" %>
			</div>
			<c:choose>
				<c:when test="${sessionScope.mem_id == 'ADMIN' }">
					<div class="insertbtn">	
						<div class="btn_1"><a href="/finref07/WriteForm?m1=02&m2=02&m3=05">글쓰기</a></div>
					</div>
				</c:when>
				<c:otherwise>
