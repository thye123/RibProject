				...
				<div>
					<a href="http://bibliotherapy.or.kr" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>치료사례, 추천도서, 학회행사 일정 및 포토갤러리 수록</li>
									
								</ul>
							</dd>
						</dl>
					</a>
					<img src="${pageContext.request.contextPath}/resources/user/images/sub/btn_homepage.png" alt="홈페이지 바로가기" class="home">	 
				</div>
			</li>
			<li>
				<div>
					<a href="http://cafe.daum.net/poetrytherapist" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>시와 책을 통해 자아성장 및 계발로 행복한 참 삶</li>
				...
				<div>
					<a href="http://www.koreanpsychology.or.kr" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>학회소개, 공격, 이타적 행동, 대인지각, 자기개념 등 심리학일반지식, 학술대회 안내</li>
				...
				<div>
					<a href="http://www.bibliotherapy.pe.kr/" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>한국독서문화재단 감사로 활동하고 계시는 이영식 목사님의 독서치료 개인홈페이지로 독서치료... 칼럼형식의 독서치료 관련 글도 직접 제공하고 있어 독서치료에 대한 전반적인 흐름도 읽을 수 있다.</li>
				...
				<div>
					<a href="http://www.gulnara.net/2/method_1.php" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>독서, 논술 독후감상문, 독서치료안내, 글쓰기, 퀴즈 및 명언자료, 추천도서 제공</li>
				...
				<div>
					<a href="http://hajebook.com" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>연구소 소개, 서평, 책을 통한 마음읽기, 좋은글, 치료후기, 독서치료자료 수록.</li>
				...
				<div>
					<a href="http://poetrytherapy.or.kr/" target="_blank">
						<dl>
							...
							<dd>
								<ul>
									<li>연구소 소개, 심리검사, 상담안내, 교육정보 등 제공.</li>
