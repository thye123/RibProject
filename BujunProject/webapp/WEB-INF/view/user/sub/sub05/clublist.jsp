			...
			var pageBtn = document.getElementsByClassName('pageBtn');
				for (var i = 0; i < pageBtn.length; i++) {
					pageBtn[i].onclick = function(e){
						...
						pageBtn[textObj-1].setAttribute("style", "background-color: red;");
					...
					success : function(data) {
						...
						if (data.count == 0) {
							...
							for (var i = start; i <= end; i++) {
								pagingTag += "<a class=pageBtn href=''><span>"
										+ i + "</span></a>";
							}
							pagingTag += "</div>";
