...
<div class="con_mob_pad">
	...
	<div class="auto_box mg_b30">
		...
		*개인정보 수집 및 동의
		...
		<form action="/opprogram01/approc?m1=${m1}&m2=${m2}&m3=${m3}" method="POST" name = "educheck" onsubmit='return mysubmit()'>
			...
			<div class="board_readWrap">
				<table class="board_read">
					...
					<tbody>
						...
						<tr>
							<th class="c">성명</th>
							<td><input type="text" name="liap_apname" class="liap_apname" placeholder="이름입력" /></td>
							<td colspan="2">
								<b>학년</b>
						...
						<tr>
							<th class="c">아이디</th>
							<td colspan="2"><input type="text" name="liap_appliyer" 
							class="liap_appliyer"
							/></td>
						</tr>
						...
						<tr>
							<th class="c">도서번호</th>
							<td><input type="text" name="liap_aprimemnum" 
							class="liap_aprimemnum"
							/></td>
						</tr>
						...
						<tr>
							<th class="c">주소</th>
							<td colspan="2">
							<input type="text" id="sample4_postcode"  name="liap_zipcode" placeholder="우편번호"> 
							<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
							<input type="text" id="sample4_roadAddress" name="liap_adress" placeholder="도로명주소">
							<input type="text" id="sample4_jibunAddress" name="liap_detailad" placeholder="지번주소">
						...
						<tr>
							...
							<select name="stel" >
								...
								type="text" name="stel3" class="stel3" />
