...
<div class="con_mob_pad">
	...
	<div id="tab_depth01" class="w33">
		<ul>
			...
			<li class="active"><a href="/mbinfo01?m1=03&m2=04&brt_gubun=1&page=1&perPageNum=10">대출중</a></li>
				...
				<div class="pagelist">
					...
					<c:choose>
						<c:when test="${pageMaker.prev}">
							<a href="/mbinfo01?m1=03&m2=04&page=${pageMaker.startPage-1}&perPageNum=10&brt_gubun=1"><span class="prevblock1 "><span>1 페이지</span></span></a>
						</c:when>
						<c:otherwise>
					...
					<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
						<c:choose>
							...
							<c:otherwise>
								<a class="default" href="/mbinfo01?m1=03&m2=04&page=${idx}&perPageNum=10&brt_gubun=1" ><span>${idx}</span></a>
							</c:otherwise>
						</c:choose>
					</c:forEach>	
					...
					<c:if test = "${pageMaker.next && pageMaker.endPage > 0}" >
						<a class="nextblock" href="/mbinfo01?m1=03&m2=04&page=${pageMaker.endPage + 1}&perPageNum=10&brt_gubun=1"><span>다음</span></a>
					</c:if>
					<a class="lastpage" href="/mbinfo01?m1=03&m2=04&page=${pageMaker.lastBlock}&perPageNum=10&brt_gubun=1"><span>마지막</span></a>
